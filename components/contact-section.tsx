...
export default function ContactSection() {
  ...
  return (
    <>
      <EnhancedContactModal isOpen={isContactModalOpen} onClose={() => setIsContactModalOpen(false)} />
              ...
              <Card className="h-full border-0 shadow-xl">
                <CardContent className="p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button
                      type="button"
                      className="btn-animated-border w-full bg-gradient-to-r from-[#ff4081] to-[#00b2ff] text-white hover:shadow-lg transform hover:scale-105 transition-all"
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">info@northblueagency.com</p>
                      </div>
                    </div>
