...
const serviceData = {
  ...
  process: [
    { title: "Discovery", description: "We understand your business, values, and goals" },
    { title: "Conceptualization", description: "We develop unique creative concepts" },
    { title: "Design", description: "We create the complete visual identity" },
    { title: "Implementation", description: "We apply the brand across all materials" },
  ],
  benefits: [
...
export default function BrandingTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/branding/${locationSlug}`;
