...
const serviceData = {
  ...
  process: [
    { title: "Analysis & Strategy", description: "We define goals, audiences, and budgets" },
    { title: "Setup", description: "We create optimized campaigns on each platform" },
    { title: "Launch", description: "We activate campaigns with real-time tracking" },
    { title: "Optimization", description: "We adjust based on data and performance" },
  ],
  benefits: [
...
export default function CampanasAdsTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/campanas-ads/${locationSlug}`;
