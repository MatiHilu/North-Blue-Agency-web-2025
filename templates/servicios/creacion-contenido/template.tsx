...
const serviceData = {
  ...
  process: [
    { title: "Initial Brief", description: "We gather your goals and brand style" },
    { title: "Planning", description: "We design the calendar and content type" },
    { title: "Creation", description: "We develop visual and multimedia pieces" },
    { title: "Delivery", description: "We schedule and delivery content ready to publish" },
  ],
  benefits: [
...
export default function CreacionContenidoTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/creacion-contenido/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/creacion-contenido" },
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">We follow a clear methodology to offer effective content</p>
            </AnimatedSection>
                ...
                <AnimatedSection key={idx} delay={idx * 100}>
                  <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-600 max-w-[250px] mx-auto text-sm">{step.description}</p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
              ))}
