...
const serviceData = {
  ...
  subtitle: "Make smart decisions based on real data from your site and social networks",
  description:
  ...
  process: [
    { title: "Initial Analysis", description: "We evaluate your goals and current systems" },
    { title: "Configuration", description: "We implement advanced tracking and tools" },
    { title: "Reporting", description: "We create personalized visual reports" },
    { title: "Optimization", description: "We analyze data and provide insights" },
  ],
  benefits: [
...
export default function AnalyticsTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/analytics/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/analytics" },
