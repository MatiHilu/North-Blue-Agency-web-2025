...
const serviceData = {
  ...
  process: [
    { title: "AI Audit", description: "We analyze how ChatGPT currently perceives and cites your brand" },
    { title: "Configuration", description: "We prepare your assets and connect to the OpenAI ad network" },
    { title: "Content Optimization", description: "We adapt your web to be the AI's preferred source" },
    { title: "Launch and Adjustment", description: "We activate ads and refine based on real queries" },
  ],
  benefits: [
...
export default function ChatgptAdsTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/chatgpt-ads/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/chatgpt-ads" },
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Why advertise on ChatGPT in {locationText}?</h2>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Strategy for Generative Engines</h2>
