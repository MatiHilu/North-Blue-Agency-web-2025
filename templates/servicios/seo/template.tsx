...
const serviceData = {
  ...
  process: [
    { title: "Initial Audit", description: "Complete analysis of your website and competition" },
    { title: "Strategy", description: "We define keywords and optimization plan" },
    { title: "Optimization", description: "We implement technical and content improvements" },
    { title: "Monitoring", description: "Rankings tracking and continuous adjustments" },
  ],
  benefits: [
...
export default function SEOTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/seo/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/seo" },
        ...
        <section className={`py-20 bg-gradient-to-br ${serviceData.gradient} text-white relative overflow-hidden`}>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection>
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mb-8">{serviceData.subtitle}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  What does this service include in {locationText}? (SEO + AIO + AEO + GEO)
                </h2>
                <p className="text-lg text-gray-600 leading-relaxed mb-8">{serviceData.description}</p>
              ...
              <AnimatedSection animation="fadeInRight" delay={200}>
                ...
                <div className="bg-gradient-to-r from-pink-50 to-cyan-50 border border-pink-200/50 rounded-xl p-6 my-10 shadow-sm">
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                    <strong>What is AIO, AEO & GEO?</strong> Artificial Intelligence Optimization combines automations and models to detect content gaps, group keywords by intent, anticipate trends, generate intelligent briefs, and monitor technical health in (almost) real-time. AEO allows us to optimize your experiences for answer engines (like SGE and chatbots), while GEO ensures presence in generative results. <strong>Always</strong> with human supervision and aligned with your business goals.
                  </p>
                </div>
              </AnimatedSection>
            </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-4xl mx-auto mb-16">
              ...
              <p className="text-lg text-white/80 leading-relaxed">
                We don't abandon SEO basics: we empower them. We add layers of applied artificial intelligence, optimization for answer engines, and generative signals that allow us to discover opportunities before the competition and execute faster without sacrificing quality. Here are some key differences.
              </p>
            </AnimatedSection>
            <SEOAIOComparison />
            <div className="mt-14 text-center max-w-2xl mx-auto text-sm text-white/60">
              * AIO, AEO, and GEO do not replace human strategy or editorial validation. They complement and amplify our process to offer you accelerated and sustainable organic growth in search engines, answer engines, and generative experiences.
            </div>
            <div className="mt-16">
              <InlineCTA
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <AnimatedSection className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">We follow a proven methodology to ensure exceptional results</p>
            </AnimatedSection>
                ...
                <AnimatedSection key={index} delay={index * 100}>
                  <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-600 max-w-[200px] mx-auto text-sm">{step.description}</p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
              ))}
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection className="max-w-3xl mb-14">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Quality and credibility of content are key for sustainable SEO. Our approach integrates{" "}
                <strong>E-E-A-T (Experience, Expertise, Authoritativeness, Trustworthiness)</strong>{" "}
                in every phase: from initial audit to specific content creation and optimization.
              </p>
            </AnimatedSection>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              {[
                { title: "Experience", body: "We reflect real business experience: cases, processes, implementation examples, and tangible results backed by internal data." },
                { title: "Expertise", body: "Deep keyword research, advanced semantic analysis, and human editorial validation on any AI-assisted output." },
                { title: "Authoritativeness", body: "We build authority combining deep content, strategic interlinking, relevant mentions, and ethical link acquisition." },
                { title: "Trustworthiness", body: "Transparency in metrics, clear policies, technical security (Core Web Vitals, HTTPS), and factual review to maintain trust." },
              ].map((item, i) => (
