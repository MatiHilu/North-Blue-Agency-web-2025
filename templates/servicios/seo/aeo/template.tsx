...
const serviceData = {
  ...
  process: [
    { title: "Conversational Research", description: "We investigate frequent questions, voice patterns, and user needs in assisted contexts." },
    { title: "Semantic Architecture", description: "We define key entities, schema, and formats that maximize eligibility in answers." },
    { title: "Production & Tests", description: "We create persuasive content, rich snippets, and guides for assistants." },
    { title: "Monitoring & Optimization", description: "We measure positioning in answer engines and adjust prompts, entities, and formats." },
  ],
  benefits: [
...
export default function AEOTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/seo/aeo/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/seo/aeo" },
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Be the Immediate and Reliable Answer in {locationText}</h2>
              ...
              <AnimatedSection animation="fadeInRight" delay={200}>
                <Card className="border-0 shadow-2xl">
                  <CardContent className="p-8">
                    <h3 className="text-2xl font-bold mb-6">Key AEO Capabilities</h3>
                    <div className="space-y-4">
        ...
        <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Methodology to Master Assisted Answers</h2>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Conversational Share of Voice", body: "We identify how much your brand appears as an answer compared to the competition in strategic queries." },
                { title: "Response Quality", body: "We evaluate clarity, factuality, and tone in each monitored response." },
                { title: "Semantic Integrity", body: "We monitor entities, relationships, and consistency with your knowledge base." },
              ].map((item, i) => (
        ...
        <FAQSection title={`AEO Questions - ${locationText}`} faqs={faqs} />
