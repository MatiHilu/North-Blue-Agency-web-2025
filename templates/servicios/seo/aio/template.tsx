...
const serviceData = {
  ...
  process: [
    { title: "Process Mapping", description: "We identify repetitive tasks and bottlenecks to prioritize automations with real impact." },
    { title: "Model Design", description: "We select models and templates, defining critical prompts and evaluation criteria." },
    { title: "Assisted Implementation", description: "We integrate AI workflows into your SEO stack and coordinate with your team for adoption." },
    { title: "Scaling & QA", description: "We monitor outputs, perform manual QA, and continuously optimize based on results." },
  ],
  benefits: [
...
export default function AIOTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/seo/aio/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/seo/aio" },
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">AI + SEO: the duo that accelerates results in {locationText}</h2>
              ...
              <AnimatedSection animation="fadeInRight" delay={200}>
                <Card className="border-0 shadow-2xl">
                  <CardContent className="p-8">
                    <h3 className="text-2xl font-bold mb-6">Capabilities enabled by AIO</h3>
                    <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-pink-50 to-cyan-50 border border-pink-200/50 rounded-xl p-6 my-10 shadow-sm">
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                    <strong>Responsible automation</strong>. Every delivery passes through human QA. We document critical prompts, evaluation criteria, and workflows to ensure consistency and transparency.
                  </p>
                </div>
              </AnimatedSection>
            </div>
        ...
        <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">How we integrate AI into your SEO stack</h2>
              <p className="text-lg text-white/80 leading-relaxed">
                We govern the full cycle: strategy, prompts, QA, and continuous improvement. These are the pillars of our AIO approach.
              </p>
            </AnimatedSection>
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection className="max-w-3xl mb-14">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We integrate performance dashboards that combine search signals, assisted production, and conversion results so you can make decisions with full context.
              </p>
            </AnimatedSection>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Prioritized opportunities", body: "Impact/effort matrices with dynamic scoring to choose actions that generate better short-term results." },
                { title: "Audited assisted production", body: "Version control, editorial checklist, and performance metrics for each piece generated or optimized with AI." },
                { title: "Monitored automations", body: "Early warnings of ranking drops, intent changes, and performance of prioritized URLs." },
              ].map((item, i) => (
        ...
        <FAQSection title={`Questions about AIO - ${locationText}`} faqs={faqs} />
