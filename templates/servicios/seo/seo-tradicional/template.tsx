...
const serviceData = {
  ...
  process: [
    { title: "Discovery & Audit", description: "We map your digital ecosystem, analyze competitors, and prioritize technical and semantic quick wins." },
    { title: "SEO Blueprint", description: "We design editorial lines, taxonomies, technical upgrades, and an incremental authority plan." },
    { title: "Implementation", description: "We execute on-page optimizations, performance improvements, and automate reporting." },
    { title: "Iteration", description: "We monitor rankings, measure conversion impact, and adjust the quarterly backlog." },
  ],
  benefits: [
...
const faqs = [
  ...
  {
    question: "Can you collaborate with internal content or development teams?",
    answer:
...
export default function SEOTradicionalTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/seo/seo-tradicional/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: "SEO & Ranking", url: "/services/seo" },
    { name: serviceData.title, url: "/services/seo/seo-tradicional" },
      ...
      <div className="min-h-screen">
        ...
        <section className={`py-20 bg-gradient-to-br ${serviceData.gradient} text-white relative overflow-hidden`}>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection>
              <Link href="/services/seo" className="inline-flex items-center text-white/80 hover:text-white mb-6 transition-colors">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Ground your organic growth on solid fundamentals in {locationText}</h2>
              ...
              <AnimatedSection animation="fadeInRight" delay={200}>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-pink-50 border border-indigo-200/50 rounded-xl p-6 my-10 shadow-sm">
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                    <strong>Why Traditional SEO 360°?</strong> Because it is the foundation that supports every advanced positioning initiative. Without technical infrastructure and content aligned to search intent, any AI- or automation-led strategy falls short.
                  </p>
                </div>
              </AnimatedSection>
            </div>
        ...
        <section className="py-24 bg-gray-900 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">From diagnosis to sustained execution</h2>
              <p className="text-lg text-white/80 leading-relaxed">
                We connect data, competitive insights, and editorial expertise to accelerate your positioning. This is our full methodology.
              </p>
            </AnimatedSection>
                ...
                <AnimatedSection key={index} delay={index * 100}>
                  <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow bg-slate-800 min-h-[250px]">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-lg text-gray-300 font-bold mb-3">{step.title}</h3>
                      <p className="text-gray-300 mx-auto text-sm">{step.description}</p>
                    </CardContent>
                  </Card>
                </AnimatedSection>
              ))}
          ...
          <div className="container mx-auto px-4">
            <AnimatedSection className="max-w-3xl mb-14">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We measure and communicate the impact of every iteration. You get clear dashboards to assess performance against your critical KPIs and adjust decisions without losing momentum.
              </p>
            </AnimatedSection>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Visibility & Rankings", body: "Ongoing tracking of positions, share of voice, and branded searches to validate impact on market perception." },
                { title: "Traffic & Conversion", body: "We configure goals, conversions, and funnels in GA4 to measure the real value of organic traffic." },
                { title: "Technical Health", body: "We monitor Core Web Vitals, crawling, indexation, and critical errors to keep your site optimized." },
              ].map((item, i) => (
        ...
        <FAQSection title={`Questions about Traditional SEO - ${locationText}`} faqs={faqs} />
