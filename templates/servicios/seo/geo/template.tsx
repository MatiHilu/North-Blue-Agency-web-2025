...
const serviceData = {
  ...
  process: [
    { title: "Semantic Discovery", description: "We analyze how generative engines interpret your brand, related entities, and available formats." },
    { title: "GEO Architecture", description: "We define content structures, curatorial prompts, and priority assets by intent." },
    { title: "Generative Production", description: "We create optimized content, enriched datasets, and visual/audio resources aligned with your goals." },
    { title: "Continuous Optimization", description: "We monitor presence in generative experiences and adjust assets based on feedback and performance." },
  ],
  benefits: [
...
export default function GEOTemplate({ locationSlug }: { locationSlug: string }) {
  const locationText = normalizeLocation(locationSlug);
  const pageUrl = `/services/seo/geo/${locationSlug}`;
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/seo/geo" },
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <AnimatedSection animation="fadeInLeft">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Lead in emerging generative results in {locationText}</h2>
              ...
              <AnimatedSection animation="fadeInRight" delay={200}>
                <Card className="border-0 shadow-2xl">
                  <CardContent className="p-8">
                    <h3 className="text-2xl font-bold mb-6">Essential GEO capabilities</h3>
                    <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-violet-50 to-orange-50 border border-violet-200/50 rounded-xl p-6 my-10 shadow-sm">
                  <p className="text-sm md:text-base text-gray-700 leading-relaxed">
                    <strong>Editorial control in the generative era</strong>. We document curatorial prompts, data sources, and guidelines so your internal teams can sustain the strategy long-term.
                  </p>
                </div>
              </AnimatedSection>
            </div>
        ...
        <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">GEO methodology centered on data and creativity</h2>
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "Coverage in AI Overviews", body: "We track the frequency and quality with which your brand appears in key generative summaries." },
                { title: "Multimodal consistency", body: "We evaluate coherence between texts, visuals, and structured data used by models." },
                { title: "Impact on demand", body: "We measure growth in brand searches, mentions, and traffic originated from generative experiences." },
              ].map((item, i) => (
        ...
        <FAQSection title={`GEO FAQs - ${locationText}`} faqs={faqs} />
