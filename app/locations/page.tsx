...
const locationServices: { slug: string; title: string; icon: React.ReactNode; locations: LocationEntry[] }[] = [
  { slug: "campanas-ads", title: "Campaigns, Ads & Digital Advertising", icon: <Target size={20} />, locations: [{ slug: "caba", display: "CABA" }, { slug: "argentina", display: "Argentina" }, { slug: "uruguay", display: "Uruguay" }, { slug: "chile", display: "Chile" }, { slug: "paraguay", display: "Paraguay" }, { slug: "bolivia", display: "Bolivia" }, { slug: "peru", display: "Peru" }, { slug: "colombia", display: "Colombia" }, { slug: "venezuela", display: "Venezuela" }, { slug: "palermo", display: "Palermo" }, { slug: "nunez", display: "Núñez" }, { slug: "belgrano", display: "Belgrano" }, { slug: "recoleta", display: "Recoleta" }, { slug: "caballito", display: "Caballito" }, { slug: "almagro", display: "Almagro" }, { slug: "vicente-lopez", display: "Vicente López" }, { slug: "san-isidro", display: "San Isidro" }, { slug: "olivos", display: "Olivos" }] },
