...
const SERVICE_DESCRIPTION = "Become the preferred answer for voice assistants and chatbots. Our AEO strategy optimizes your brand for Siri, Alexa, and Bing Copilot.";
