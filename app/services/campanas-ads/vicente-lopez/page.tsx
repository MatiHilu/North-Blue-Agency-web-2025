...
const SERVICE_DESCRIPTION = "Maximize ROI with data-driven ad campaigns on Google, Meta, and LinkedIn. We design and execute strategies for sustainable business growth.";
