...
import { generateMetadata as baseGenerateMetadata } from "../../servicios/redes-sociales/page";
...
export async function generateMetadata({
  ...
  const canonicalEs = `${BASE_URL}/servicios/redes-sociales${
    slug ? `-${slug}` : ""
  }`;
...
export { default } from "../../servicios/redes-sociales/page";
