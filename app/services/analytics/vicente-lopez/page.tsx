...
const LOCATION_DISPLAY = "Vicente López";
const SERVICE_TITLE = "Analytics - Web & Social Media Reports";
const SERVICE_DESCRIPTION = "Transform data into growth with our advanced web and social analytics. We implement tracking systems to optimize your strategy based on actionable insights.";
