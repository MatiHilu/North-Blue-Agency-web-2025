...
const serviceData = {
  ...
  subtitle: "Comunicación visual que conecta y convierte",
  description:
    "Creamos piezas gráficas impactantes que comunican eficazmente el mensaje de tu marca. Desde material publicitario hasta presentaciones corporativas, nuestro equipo de diseñadores combina creatividad y estrategia para generar contenido visual que realmente funciona.",
  gradient: "from-[#00b2ff] to-[#33c3ff]",
  price: "Desde $200/pieza",
  duration: "2-5 días por proyecto",
  features: [
    "Material publicitario impreso y digital",
    "Presentaciones corporativas dinámicas",
    "Infografías y visualización de datos",
    "Diseño de packaging y etiquetas",
    "Banners y material web",
  ...
  process: [
    {
      ...
      description: "Entendemos tus objetivos y mensaje clave",
    },
    {
      title: "Conceptualización",
      description: "Desarrollamos propuestas creativas alineadas",
    },
    {
      title: "Diseño",
      description: "Creamos las piezas con atención al detalle",
    },
    {
      title: "Entrega",
      description: "Proporcionamos archivos listos para producción",
    },
  ],
  benefits: [
    "Comunicación visual más efectiva",
    "Coherencia con la identidad de marca",
    "Mayor impacto en materiales promocionales",
...
const faqs = [
  {
    question: "¿Qué formatos de archivo proporcionan?",
    answer:
      "Entregamos en todos los formatos necesarios: PDF para impresión, PNG/JPG para web, vectoriales (AI/EPS) para escalabilidad, y formatos específicos según el uso final de cada pieza.",
  },
  {
    question: "¿Incluyen revisiones en el proceso?",
    answer:
      "Sí, incluimos hasta 3 rondas de revisiones por proyecto para asegurar que el resultado final cumpla exactamente con tus expectativas y necesidades.",
  },
  {
    question: "¿Pueden adaptar diseños existentes?",
    answer:
      "Absolutamente. Podemos trabajar con tu material existente para crear nuevas piezas manteniendo la coherencia visual, o actualizar diseños previos con nuevas tendencias.",
  },
];
          ...
          <div className="container mx-auto px-4 text-center">
            <AnimatedSection>
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Contáctanos hoy y descubre cómo el diseño gráfico puede
