...
export async function generateMetadata({
  ...
  const canonical = `${BASE_URL}/services/web-development${slugPart}`;
...
export default function WebDevelopmentPage({
  ...
  const schemaBreadcrumb = breadcrumbSchema([
    ...
    { name: serviceData.title, url: "/services/web-development" },
  ]);
  return (
    <>
                ...
                <div className="h-full p-8 rounded-2xl bg-white ring-1 ring-gray-200/70 shadow-md">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-3">
                      ...
                      <span>WooCommerce: total flexibility on WordPress</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 bg-[#00b2ff] rounded-full flex items-center justify-center">
                        <Check className="text-white" size={12} />
                      </div>
                      <span>Shopify: fast time-to-market and app ecosystem</span>
                    </li>
                  </ul>
            ...
            <div className="grid gap-10 md:grid-cols-3">
              <AnimatedSection>
                <div>
                  ...
                  <p className="text-gray-700 mb-3">Plans to keep your site secure and updated.</p>
                  <ul className="space-y-2 text-gray-700">
                    {["Secure updates and backups", "24/7 monitoring and security patches", "Ticket/WhatsApp support and SLA"].map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="w-5 h-5 bg-[#ff4081] rounded-full flex items-center justify-center">
                          <Check className="text-white" size={12} />
                        </div>
              ...
              <AnimatedSection>
                <div>
                  <h3 className="text-xl font-bold mb-2">Updates & Improvements</h3>
                  <p className="text-gray-700 mb-3">Redesigns, landing pages, and new integrations.</p>
                  <ul className="space-y-2 text-gray-700">
                    {["Redesigns and campaign landing pages", "Integrations (CRM, payments, chat)", "Accessibility, multi-language, and optimizations"].map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="w-5 h-5 bg-[#ff4081] rounded-full flex items-center justify-center">
                          <Check className="text-white" size={12} />
                        </div>
              ...
              <AnimatedSection>
                <div>
                  <h3 className="text-xl font-bold mb-2">Hosting & Launch</h3>
                  <p className="text-gray-700 mb-3">First year included. We also work with your provider.</p>
                  <ul className="space-y-2 text-gray-700">
                    {["SSL, automatic backups, and security", "Cache optimization / CDN", "Optional: staging, dedicated servers, and CI/CD"].map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        <div className="w-5 h-5 bg-[#ff4081] rounded-full flex items-center justify-center">
                          <Check className="text-white" size={12} />
                        </div>
