...
export default function DesarrolloWebPage() {
  ...
  const schema = {
    ...
    keywords: "desarrollo web, sitios web, creación de páginas, next.js",
    areaServed: "ES",
    ...
    breadcrumb: {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 3,
          name: serviceData.title,
          item: `${BASE_URL}/servicios/desarrollo-web`,
        },
      ],
    },
  };
  ...
  return (
    <>
      <SEOHead
        title="Desarrollo Web - North Blue Agency"
